...
export interface GridWithPaginationProps{
  items: Array<any>,
  rowSpacing: any,
  columnSpacing: any,
...
const gridWithPaginationDefaultProps: GridWithPaginationProps = {
  items: [],
  rowSpacing:6,
...
function GridWithPagination({items, rowSpacing, columnSpacing, numberOfItems,pagination}:GridWithPaginationProps){
